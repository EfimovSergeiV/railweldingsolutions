...
<template>
  <div class="">
          ...
          <div class="flex items-center gap-8 py-2">
            <div class="flex gap-2">
              <div class="bg-white w-[400px] flex items-center justify-center">
                <img src="/prod/МРСК-01-front.png" class=" w-[400px] py-4" />
              </div>
    ...
    <div class="container mx-auto lg:max-w-7xl lg:px-8">
      ...
      <div class="">
        <Swiper
          class="rounded-md relative h-[18rem] flex items-center justify-center"
          :modules="[]"
          :slides-per-view="4"
          :loop="true"
          :effect="'fade'"
          ...
          <SwiperSlide v-for="slide in 9" :key="slide" class="bg-white">
            <div class="">
              <div class="">
                <img src="/prod/fbm-140.png" class="w-[240px]" />
              </div>
              <div class="py-2 flex items-center justify-center">
                <p class="text-sky-950 text-sm font-opensans font-semibold">FBM-{{slide}}40</p>
              </div>
            </div>
      ...
      <div class="grid grid-cols-1 gap-4">
        <div class="">
          <div class="py-2">
            <p class="text-sky-950 text-base font-opensans font-semibold">FBM-140</p>
          </div>
